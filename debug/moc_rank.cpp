...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_rank_t, stringdata) + ofs \
...
const QMetaObject rank::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rank.data,
      qt_meta_data_rank,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *rank::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rank.stringdata))
        return static_cast<void*>(const_cast< rank*>(this));
